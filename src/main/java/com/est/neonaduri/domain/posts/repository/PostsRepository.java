...
import com.est.neonaduri.domain.search.repository.SearchCustomRepository;
...
@Repository
public interface PostsRepository extends JpaRepository<Posts,String>, SearchCustomRepository {
