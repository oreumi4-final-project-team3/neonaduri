...
document.addEventListener('DOMContentLoaded', function () {
    ...
    regionButtons.forEach(button => {
        button.addEventListener('click', function () {
            ...
            fetchSpots(areaCode);
            window.history.pushState({areaCode: areaCode}, `Region ${areaCode}`, `/spots/${areaCode}`);
            location.href = `/spots/${areaCode}`; // 주소를 변경 후 페이지를 새로고침합니다.
        });
    });
});

function fetchSpots(areaCode) {
    fetch(`/spots/${areaCode}`)
...
function getImagePathByRegion(region) {
    switch (region) {
        case '1':
            return '/images/seoul.png';
            break;
        case '2':
            return '/images/incheon.jpg';
            break;
        case '31':
            return '/images/kyungki.jpg';
            break;
        case '32':
            return '/images/kangwon.jpg';
            break;
        case '33':
            return '/images/chungbuk.png';
            break;
        case '34':
            return '/images/chungnam.jpg';
            break;
        case '35':
            return '/images/kyungbuk.jpg';
            break;
        case '36':
            return '/images/kyungnam.jpg';
            break;
        case '37':
            return '/images/jeonbuk.jpg';
            break;
        case '38':
            return '/images/jeonnam.jpg';
            break;
        case '39':
            return '/images/jeju.jpg';
            break;
